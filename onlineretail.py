...
plt.title("Optimal value of K using Elbow Method")
plt.show()
print("\nThe optimal value of k is 3.")
"""The Optimal Number of k is 3 in this case. From point 3 to four, the decrease distance reduces, 
compared to the one between 2 and 3. Therefore, three is the optimal value. """
